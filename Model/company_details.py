from sqlalchemy import Boolean, Column, Float, Integer, String, Text, BigInteger
...
class Company_Details(Base):
    ...
    lastFiscalYearEnd = Column(BigInteger)
    ...
    nextFiscalYearEnd = Column(BigInteger)
    mostRecentQuarter = Column(BigInteger)
    shortRatio = Column(Float)
    sharesShortPreviousMonthDate = Column(BigInteger)
    floatShares = Column(BigInteger)
    beta = Column(Float)
    enterpriseValue = Column(BigInteger)
    priceHint = Column(Integer)
    lastSplitDate = Column(BigInteger)
    lastSplitFactor = Column(String)
    lastDividendDate = Column(BigInteger)
    earningsQuarterlyGrowth = Column(Float)
    priceToSalesTrailing12Months = Column(Float)
    dateShortInterest = Column(BigInteger)
    ...
    exDividendDate = Column(BigInteger)
