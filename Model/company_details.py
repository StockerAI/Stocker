from sqlalchemy import Boolean, Column, Float, Integer, String, Text, BigInteger, DateTime
...
class Company_Details(Base):
    ...
    lastFiscalYearEnd = Column(DateTime)
